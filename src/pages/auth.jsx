      ...
      <form onSubmit={registerForm.handleSubmit}>
        <input
          className={`form-control ${
            registerForm.errors.username ? "form-error" : ""
          }`}
          type="text"
          name="username"
        ...
        <input
          className={`form-control ${
            registerForm.errors.email ? "form-error" : ""
          }`}
          type="text"
          name="email"
        ...
        <input
          className={`form-control ${
            registerForm.errors.password ? "form-error" : ""
          }`}
          type="password"
          name="password"
        ...
        <div className="form-button">
          ...
          >
            {registering ? (
              <BeatLoader size={10} color="#0093ff" />
            ) : (
              "Register"
            )}
          </button>
  ...
  const displayLoginForm = () => {
    return (
      <form onSubmit={loginForm.handleSubmit}>
        <input
          className={`form-control ${
            loginForm.errors.email ? "form-error" : ""
          }`}
          id="email"
          type="text"
          name="email"
        ...
        <input
          className={`form-control ${
            loginForm.errors.password ? "form-error" : ""
          }`}
          type="password"
          name="password"
          placeholder="Password"
          ...
          <div className="form-holder">
            <div className="form-content">
              <div className="form-items">
                ...
                {tabNo === 0 ? displayLoginForm() : displayRegisterForm()}
              </div>
            </div>
          </div>
        </div>
